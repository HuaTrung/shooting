...
//	"log"
//	"net/http"
//	"shootingplane/pkg/token"
//	"time"
//	"github.com/gorilla/websocket"
//	"shootingplane/database"
//	"go.uber.org/zap"
//)
//
//var (
...
//	quit chan struct{}
//
//	models     *database.ConnMongo
//	logger *zap.Logger
//}
//
//// New returns a new Chat application.
//	func New(models *database.ConnMongo,  logger *zap.Logger) *Chat {
//	c := Chat{
...
//				_, err := c.models.CreateConversationReply(msg.Sender, msg.Receiver, msg.Text)
//				if err != nil {
...
//
//		// Check the models and get the user info, then tie them together.
...
//		zap.String("user", uid.String()))
//	rooms, err := c.models.GetRooms(string(uid))
//	if err != nil {
